...
if (connection == 'open') {
console.log(chalk.yellow('▣──────────────────────────────···\n│\n│❧ Se Conectó Correctamente Al Wazap 👻 \n│\n▣──────────────────────────────···'))}
}
...
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ 𝙷𝙰𝚂𝚃𝙰 𝙿𝚁𝙾𝙽𝚃𝙾 👋🏻* \n*╚══════════════*'
conn.spromote = '*Heyy @user Ahora Eres Admin !!*'
conn.sdemote = '* La Perra De @user Ya No Es Admin :( !!*'
conn.sDesc = '*Se Cambió La Descripción Del Grupo *\n\n*𝙽𝚄𝙴𝚅𝙰 𝙳𝙴𝚂𝙲𝚁𝙸𝙿𝙲𝙸𝙾𝙽:* @desc'
conn.sSubject = '*Se Cambió El Nombre Del Grupo*\n*𝙽𝚄𝙴𝚅𝙾 𝙽𝙾𝙼𝙱𝚁𝙴:* @subject'
conn.sIcon = '*Se Cambió La Foto Del Grupo !!*'
